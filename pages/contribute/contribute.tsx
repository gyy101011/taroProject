...
const Contribute = () => {
  ...
  const handleUrlChange = e => {
    ...
    let pan = findePanType(contributeForm.downloadUrl, contributeTypeList.panList)
    if (!pan) {
  ...
  const findePanType = (value: string, list: CategoryType[]) => {
    ...
    <>
      ...
      <View className='contribute'>
        <AtForm onSubmit={handleSubmitClick}>
          ...
          <AtAccordion open={tagOpen} onClick={() => setTagOpen(!tagOpen)} title='标签'>
            <AtList hasBorder>
